...
`;
  ...
  return (
    <div className="min-h-[100dvh] bg-background text-foreground bg-pattern relative flex flex-col font-sans w-full">
      {/* Decorative Elements - Simplified for mobile performance */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none -z-10" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary/5 rounded-full translate-y-1/2 -translate-x-1/2 pointer-events-none -z-10" />
